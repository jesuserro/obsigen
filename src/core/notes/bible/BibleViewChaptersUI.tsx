                                                    ...
                                                    >
                                                        ...
                                                        {image.coordinates && (
                                                            <div className="map-overlay" onClick={(e) => e.stopPropagation()}>
                                                                <a href={`obsidian://mapview?do=open&centerLat=${image.coordinates[0]}&centerLng=${image.coordinates[1]}&chosenMapSource=0&linkColor=red&mapZoom=13&name=Default&query=&showLinks=false`} target="_blank" title={image.locations ? image.locations[0].replace(/\[\[|\]\]/g, '') : ''}>
