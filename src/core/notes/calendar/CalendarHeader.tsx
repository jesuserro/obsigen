...
interface CalendarHeaderProps {
  ...
  onBookClick: () => void;
  isBibleView: boolean; // Prop para indicar la vista actual
}
...
const CalendarHeader: React.FC<CalendarHeaderProps> = ({
  ...
  onYearChange,
  onBookClick,
  isBibleView, // Recibir el prop
}) => {
  return (
    <>
      <div className="header-container">
        <button onClick={onBookClick} className="switcher-button">
          {/* Cambiar el ícono basado en el estado de la vista */}
          {isBibleView ? (
            <svg
            ...
            <svg
              ...
              viewBox="0 0 16 16"
            >
              <path d="M0 1.5A.5.5 0 0 1 .5 1h7a.5.5 0 0 1 0 1H1v12h6.5a.5.5 0 0 1 0 1h-7a.5.5.5 0 0 1-.5-.5v-13z"/>
              <path d="M2 2v12h6.5a.5.5 0 0 0 .5-.5v-11a.5.5 0 0 0-.5-.5H2z"/>
              <path d="M10.5 1h-1v14h1a2 2 0 0 0 2-2V3a2 2 0 0 0-2-2z"/>
            </svg>
          )}
        </button>
        {/* Ocultar el botón de añadir evento y el selector de años si isBibleView es true */}
        {!isBibleView && (
          <>
