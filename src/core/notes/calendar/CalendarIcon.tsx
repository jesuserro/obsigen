...
export const iconMap: { [key: string]: (props: { size: number }) => JSX.Element } = {
    ...
    angry: ({ size }) => <FaAngry size={size} className="red" />,
    ...
    chess: ({ size }) => <FaChess size={size} className="white" />,
    ...
    kindle: ({ size }) => <FaBookReader size={size} className="white" />,
    ...
    plane: ({ size }) => <GiCommercialAirplane size={size} style={{ color: '#1199c2' }} />,
